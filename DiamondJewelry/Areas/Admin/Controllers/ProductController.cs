...
using DiamondJewelry.Areas.Admin.Models;
...
namespace DiamondJewelry.Areas.Admin.Controllers
{
    ...
    {
        private readonly AspnetCoreStarterMvcContext _context;

        public ProductController(AspnetCoreStarterMvcContext context)
        {
            _context = context;
        }
